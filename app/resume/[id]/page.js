      ...
      <div style={{
          ...
          <div style={{ padding: '25px' }}>
            ...
            {activeSection === 'summary' && (
              <div>
                ...
                <p style={{ color: '#666', fontSize: '14px', marginBottom: '20px' }}>Write 3-4 sentences about your professional background</p>
                <textarea value={resume.summary} onChange={(e) => setResume(prev => ({ ...prev, summary: e.target.value }))} placeholder="Experienced software engineer..." style={{ ...inputStyle, minHeight: '200px', resize: 'vertical' }} />
              </div>
            )}
            ...
            {activeSection === 'experience' && (
              <div>
                ...
                {resume.experience.length === 0 && (
                  <p style={{ color: '#999', textAlign: 'center', padding: '40px' }}>No experience added yet.</p>
                )}
                ...
                {resume.experience.map((exp, index) => (
                  <div key={exp.id} style={{ border: '1px solid #e0e0e0', padding: '20px', borderRadius: '10px', marginBottom: '15px' }}>
                    ...
                    <textarea value={exp.description} onChange={(e) => updateExperience(exp.id, 'description', e.target.value)} placeholder="• Led team of 5 engineers..." style={{ ...inputStyle, minHeight: '100px' }} />
                  </div>
                ))}
              </div>
            )}
            ...
            {activeSection === 'education' && (
              <div>
                ...
                {resume.education.length === 0 && (
                  <p style={{ color: '#999', textAlign: 'center', padding: '40px' }}>No education added yet.</p>
                )}
                  ...
                  <div key={edu.id} style={{ border: '1px solid #e0e0e0', padding: '20px', borderRadius: '10px', marginBottom: '15px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '10px' }}>
                      <div>
                        ...
                        <input type="text" value={edu.startDate} onChange={(e) => updateEducation(edu.id, 'startDate', e.target.value)} placeholder="2018" style={inputStyle} />
                      </div>
                      <div>
                        <label style={labelStyle}>End</label>
                        <input type="text" value={edu.endDate} onChange={(e) => updateEducation(edu.id, 'endDate', e.target.value)} placeholder="2022" style={inputStyle} />
                      </div>
                      <div>
                        <label style={labelStyle}>Grade</label>
                        <input type="text" value={edu.grade} onChange={(e) => updateEducation(edu.id, 'grade', e.target.value)} placeholder="8.5 CGPA" style={inputStyle} />
                      </div>
                    </div>
                  </div>
                ))}
            ...
            {activeSection === 'skills' && (
              <div>
                ...
                <p style={{ color: '#666', fontSize: '14px', marginBottom: '20px' }}>Type a skill and press Enter to add</p>
                
                <input type="text" placeholder="React, Python, Communication... (Press Enter)" onKeyDown={(e) => {
                ...
                {resume.skills.length === 0 && (
                  <p style={{ color: '#999', textAlign: 'center', padding: '20px' }}>No skills added yet</p>
                )}
              </div>
            )}
            ...
            {activeSection === 'projects' && (
              <div>
                ...
                {resume.projects.length === 0 && (
                  <p style={{ color: '#999', textAlign: 'center', padding: '40px' }}>No projects added yet.</p>
                )}
                ...
                {resume.projects.map((proj, index) => (
                  <div key={proj.id} style={{ border: '1px solid #e0e0e0', padding: '20px', borderRadius: '10px', marginBottom: '15px' }}>
                    ...
                    <input type="text" value={proj.tech} onChange={(e) => updateProject(proj.id, 'tech', e.target.value)} placeholder="React, Node.js, MongoDB" style={inputStyle} />

                    <label style={labelStyle}>Link</label>
                    <input type="text" value={proj.link} onChange={(e) => updateProject(proj.id, 'link', e.target.value)} placeholder="github.com/yourproject" style={inputStyle} />
        ...
        <div style={{
          ...
          <div style={{ borderBottom: '3px solid #667eea', paddingBottom: '20px', marginBottom: '25px' }}>
            <h1 style={{ fontSize: '2.5rem', color: '#1a1a2e', marginBottom: '5px' }}>
              {resume.personal.fullName || 'Your Name'}
            </h1>
            <p style={{ fontSize: '1.2rem', color: '#667eea', marginBottom: '15px', fontWeight: '500' }}>
          ...
          {resume.skills.length > 0 && (
            <div style={{ marginBottom: '25px' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
                {resume.skills.map(skill => (
                  <span key={skill} style={{ background: '#f0f0ff', color: '#667eea', padding: '6px 14px', borderRadius: '20px', fontSize: '14px', fontWeight: '500' }}>{skill}</span>
                ))}
              </div>
            </div>
          )}
